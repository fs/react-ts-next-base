...
export type RemoveProductFromFavoritesMutationVariables = Types.Exact<{
  input: Types.RemoveProductFromFavoritesInput;
}>;

export type RemoveProductFromFavoritesMutation = {
  __typename?: 'Mutation';
...
export const RemoveProductFromFavoritesDocument = gql`
  mutation RemoveProductFromFavorites($input: RemoveProductFromFavoritesInput!) {
    removeProductFromFavorites(input: $input) {
      ...ProductInfo
    }
  }
...
export function useRemoveProductFromFavoritesMutation(
  ...
  return Apollo.useMutation<
    RemoveProductFromFavoritesMutation,
    RemoveProductFromFavoritesMutationVariables
  >(RemoveProductFromFavoritesDocument, options);
}
export type RemoveProductFromFavoritesMutationHookResult = ReturnType<
  typeof useRemoveProductFromFavoritesMutation
>;
export type RemoveProductFromFavoritesMutationResult =
  Apollo.MutationResult<RemoveProductFromFavoritesMutation>;
