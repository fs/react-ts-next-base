...
export type SubmitProductDeliveryConditionStepMutationVariables = Types.Exact<{
  input: Types.SubmitProductDeliveryConditionsStepInput;
}>;

export type SubmitProductDeliveryConditionStepMutation = {
  __typename?: 'Mutation';
  submitProductDeliveryConditionsStep?: {
    __typename?: 'Product';
...
export const SubmitProductDeliveryConditionStepDocument = gql`
  mutation SubmitProductDeliveryConditionStep($input: SubmitProductDeliveryConditionsStepInput!) {
    submitProductDeliveryConditionsStep(input: $input) {
      ...ProductInfo
    }
  }
  ${ProductInfoFragmentDoc}
`;
export type SubmitProductDeliveryConditionStepMutationFn = Apollo.MutationFunction<
  SubmitProductDeliveryConditionStepMutation,
  SubmitProductDeliveryConditionStepMutationVariables
>;

/**
 * __useSubmitProductDeliveryConditionStepMutation__
 *
 * To run a mutation, you first call `useSubmitProductDeliveryConditionStepMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubmitProductDeliveryConditionStepMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [submitProductDeliveryConditionStepMutation, { data, loading, error }] = useSubmitProductDeliveryConditionStepMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSubmitProductDeliveryConditionStepMutation(
  ...
  return Apollo.useMutation<
    SubmitProductDeliveryConditionStepMutation,
    SubmitProductDeliveryConditionStepMutationVariables
  >(SubmitProductDeliveryConditionStepDocument, options);
}
export type SubmitProductDeliveryConditionStepMutationHookResult = ReturnType<
  typeof useSubmitProductDeliveryConditionStepMutation
>;
export type SubmitProductDeliveryConditionStepMutationResult =
  Apollo.MutationResult<SubmitProductDeliveryConditionStepMutation>;
export type SubmitProductDeliveryConditionStepMutationOptions = Apollo.BaseMutationOptions<
  SubmitProductDeliveryConditionStepMutation,
  SubmitProductDeliveryConditionStepMutationVariables
>;
