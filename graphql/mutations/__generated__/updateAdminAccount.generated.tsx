...
export type UpdateAdminAccountMutationVariables = Types.Exact<{
...
export const UpdateAdminAccountDocument = gql`
  mutation UpdateAdminAccount($input: UpdateAdminAccountInput!) {
...
`;
export type UpdateAdminAccountMutationFn = Apollo.MutationFunction<
...
export function useUpdateAdminAccountMutation(
  ...
  return Apollo.useMutation<UpdateAdminAccountMutation, UpdateAdminAccountMutationVariables>(
    UpdateAdminAccountDocument,
    options,
  );
}
...
export type UpdateAdminAccountMutationOptions = Apollo.BaseMutationOptions<
  UpdateAdminAccountMutation,
  UpdateAdminAccountMutationVariables
>;
