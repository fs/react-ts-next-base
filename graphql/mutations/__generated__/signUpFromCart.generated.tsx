...
export type SignUpFromCartMutationVariables = Types.Exact<{
  input: Types.SignUpInput;
}>;

export type SignUpFromCartMutation = {
  __typename?: 'Mutation';
  signUpFromCart?: {
...
export const SignUpFromCartDocument = gql`
  mutation SignUpFromCart($input: SignUpInput!) {
    signUpFromCart(input: $input) {
      me {
        ...CurrentUserInfo
      }
      message
...
`;
export type SignUpFromCartMutationFn = Apollo.MutationFunction<
  SignUpFromCartMutation,
  SignUpFromCartMutationVariables
>;

/**
 * __useSignUpFromCartMutation__
 *
 * To run a mutation, you first call `useSignUpFromCartMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSignUpFromCartMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [signUpFromCartMutation, { data, loading, error }] = useSignUpFromCartMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSignUpFromCartMutation(
  baseOptions?: Apollo.MutationHookOptions<SignUpFromCartMutation, SignUpFromCartMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<SignUpFromCartMutation, SignUpFromCartMutationVariables>(
    SignUpFromCartDocument,
    options,
  );
}
export type SignUpFromCartMutationHookResult = ReturnType<typeof useSignUpFromCartMutation>;
export type SignUpFromCartMutationResult = Apollo.MutationResult<SignUpFromCartMutation>;
export type SignUpFromCartMutationOptions = Apollo.BaseMutationOptions<
  SignUpFromCartMutation,
  SignUpFromCartMutationVariables
>;
