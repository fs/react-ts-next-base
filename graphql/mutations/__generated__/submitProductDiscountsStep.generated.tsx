...
export type SubmitProductDiscountsStepMutationVariables = Types.Exact<{
  input: Types.SubmitProductDiscountsStepInput;
}>;

export type SubmitProductDiscountsStepMutation = {
  __typename?: 'Mutation';
  submitProductDiscountsStep?: {
    __typename?: 'Product';
...
export const SubmitProductDiscountsStepDocument = gql`
  mutation SubmitProductDiscountsStep($input: SubmitProductDiscountsStepInput!) {
    submitProductDiscountsStep(input: $input) {
      ...ProductInfo
    }
  }
  ${ProductInfoFragmentDoc}
`;
export type SubmitProductDiscountsStepMutationFn = Apollo.MutationFunction<
  SubmitProductDiscountsStepMutation,
  SubmitProductDiscountsStepMutationVariables
>;

/**
 * __useSubmitProductDiscountsStepMutation__
 *
 * To run a mutation, you first call `useSubmitProductDiscountsStepMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubmitProductDiscountsStepMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [submitProductDiscountsStepMutation, { data, loading, error }] = useSubmitProductDiscountsStepMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSubmitProductDiscountsStepMutation(
  ...
  return Apollo.useMutation<
    SubmitProductDiscountsStepMutation,
    SubmitProductDiscountsStepMutationVariables
  >(SubmitProductDiscountsStepDocument, options);
}
export type SubmitProductDiscountsStepMutationHookResult = ReturnType<
  typeof useSubmitProductDiscountsStepMutation
>;
export type SubmitProductDiscountsStepMutationResult =
  Apollo.MutationResult<SubmitProductDiscountsStepMutation>;
export type SubmitProductDiscountsStepMutationOptions = Apollo.BaseMutationOptions<
  SubmitProductDiscountsStepMutation,
  SubmitProductDiscountsStepMutationVariables
>;
