...
export type SubmitProductDeliveryStepMutationVariables = Types.Exact<{
  input: Types.SubmitProductDeliveryStepInput;
}>;

export type SubmitProductDeliveryStepMutation = {
  __typename?: 'Mutation';
  submitProductDeliveryStep?: {
    __typename?: 'Product';
...
export const SubmitProductDeliveryStepDocument = gql`
  mutation SubmitProductDeliveryStep($input: SubmitProductDeliveryStepInput!) {
    submitProductDeliveryStep(input: $input) {
      ...ProductInfo
    }
  }
  ${ProductInfoFragmentDoc}
`;
export type SubmitProductDeliveryStepMutationFn = Apollo.MutationFunction<
  SubmitProductDeliveryStepMutation,
  SubmitProductDeliveryStepMutationVariables
>;

/**
 * __useSubmitProductDeliveryStepMutation__
 *
 * To run a mutation, you first call `useSubmitProductDeliveryStepMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubmitProductDeliveryStepMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [submitProductDeliveryStepMutation, { data, loading, error }] = useSubmitProductDeliveryStepMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSubmitProductDeliveryStepMutation(
  ...
  return Apollo.useMutation<
    SubmitProductDeliveryStepMutation,
    SubmitProductDeliveryStepMutationVariables
  >(SubmitProductDeliveryStepDocument, options);
}
export type SubmitProductDeliveryStepMutationHookResult = ReturnType<
  typeof useSubmitProductDeliveryStepMutation
>;
export type SubmitProductDeliveryStepMutationResult =
  Apollo.MutationResult<SubmitProductDeliveryStepMutation>;
export type SubmitProductDeliveryStepMutationOptions = Apollo.BaseMutationOptions<
  SubmitProductDeliveryStepMutation,
  SubmitProductDeliveryStepMutationVariables
>;
