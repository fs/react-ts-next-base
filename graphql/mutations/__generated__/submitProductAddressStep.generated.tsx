...
export type SubmitProductAddressStepMutationVariables = Types.Exact<{
  input: Types.SubmitProductAddressStepInput;
}>;

export type SubmitProductAddressStepMutation = {
  __typename?: 'Mutation';
  submitProductAddressStep?: {
    __typename?: 'Product';
...
export const SubmitProductAddressStepDocument = gql`
  mutation SubmitProductAddressStep($input: SubmitProductAddressStepInput!) {
    submitProductAddressStep(input: $input) {
      ...ProductInfo
    }
  }
  ${ProductInfoFragmentDoc}
`;
export type SubmitProductAddressStepMutationFn = Apollo.MutationFunction<
  SubmitProductAddressStepMutation,
  SubmitProductAddressStepMutationVariables
>;

/**
 * __useSubmitProductAddressStepMutation__
 *
 * To run a mutation, you first call `useSubmitProductAddressStepMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubmitProductAddressStepMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [submitProductAddressStepMutation, { data, loading, error }] = useSubmitProductAddressStepMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSubmitProductAddressStepMutation(
  ...
  return Apollo.useMutation<
    SubmitProductAddressStepMutation,
    SubmitProductAddressStepMutationVariables
  >(SubmitProductAddressStepDocument, options);
}
export type SubmitProductAddressStepMutationHookResult = ReturnType<
  typeof useSubmitProductAddressStepMutation
>;
export type SubmitProductAddressStepMutationResult =
  Apollo.MutationResult<SubmitProductAddressStepMutation>;
export type SubmitProductAddressStepMutationOptions = Apollo.BaseMutationOptions<
  SubmitProductAddressStepMutation,
  SubmitProductAddressStepMutationVariables
>;
