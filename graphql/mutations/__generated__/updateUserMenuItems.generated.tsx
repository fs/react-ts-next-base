...
export type UpdateUserMenuItemsMutationVariables = Types.Exact<{
  input: Types.UpdateUserMenuItemsInput;
}>;

export type UpdateUserMenuItemsMutation = {
  __typename?: 'Mutation';
  updateUserMenuItems?: {
...
export const UpdateUserMenuItemsDocument = gql`
  mutation updateUserMenuItems($input: UpdateUserMenuItemsInput!) {
    updateUserMenuItems(input: $input) {
      ...CurrentUserInfo
    }
  }
  ${CurrentUserInfoFragmentDoc}
`;
export type UpdateUserMenuItemsMutationFn = Apollo.MutationFunction<
  UpdateUserMenuItemsMutation,
  UpdateUserMenuItemsMutationVariables
>;

/**
 * __useUpdateUserMenuItemsMutation__
 *
 * To run a mutation, you first call `useUpdateUserMenuItemsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateUserMenuItemsMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateUserMenuItemsMutation, { data, loading, error }] = useUpdateUserMenuItemsMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateUserMenuItemsMutation(
  ...
  return Apollo.useMutation<UpdateUserMenuItemsMutation, UpdateUserMenuItemsMutationVariables>(
    UpdateUserMenuItemsDocument,
    options,
  );
}
export type UpdateUserMenuItemsMutationHookResult = ReturnType<
  typeof useUpdateUserMenuItemsMutation
>;
export type UpdateUserMenuItemsMutationResult = Apollo.MutationResult<UpdateUserMenuItemsMutation>;
export type UpdateUserMenuItemsMutationOptions = Apollo.BaseMutationOptions<
  UpdateUserMenuItemsMutation,
  UpdateUserMenuItemsMutationVariables
>;
