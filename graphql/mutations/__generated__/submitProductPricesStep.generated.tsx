...
export type SubmitProductPricesStepMutationVariables = Types.Exact<{
  input: Types.SubmitProductPricesStepInput;
}>;

export type SubmitProductPricesStepMutation = {
  __typename?: 'Mutation';
  submitProductPricesStep?: {
    __typename?: 'Product';
...
export const SubmitProductPricesStepDocument = gql`
  mutation SubmitProductPricesStep($input: SubmitProductPricesStepInput!) {
    submitProductPricesStep(input: $input) {
      ...ProductInfo
    }
  }
  ${ProductInfoFragmentDoc}
`;
export type SubmitProductPricesStepMutationFn = Apollo.MutationFunction<
  SubmitProductPricesStepMutation,
  SubmitProductPricesStepMutationVariables
>;

/**
 * __useSubmitProductPricesStepMutation__
 *
 * To run a mutation, you first call `useSubmitProductPricesStepMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubmitProductPricesStepMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [submitProductPricesStepMutation, { data, loading, error }] = useSubmitProductPricesStepMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSubmitProductPricesStepMutation(
  ...
  return Apollo.useMutation<
    SubmitProductPricesStepMutation,
    SubmitProductPricesStepMutationVariables
  >(SubmitProductPricesStepDocument, options);
}
export type SubmitProductPricesStepMutationHookResult = ReturnType<
  typeof useSubmitProductPricesStepMutation
>;
export type SubmitProductPricesStepMutationResult =
  Apollo.MutationResult<SubmitProductPricesStepMutation>;
export type SubmitProductPricesStepMutationOptions = Apollo.BaseMutationOptions<
  SubmitProductPricesStepMutation,
  SubmitProductPricesStepMutationVariables
>;
