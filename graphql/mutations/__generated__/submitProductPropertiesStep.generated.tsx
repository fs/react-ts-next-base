...
export type SubmitProductPropertiesStepMutationVariables = Types.Exact<{
  input: Types.SubmitProductPropertiesStepInput;
}>;

export type SubmitProductPropertiesStepMutation = {
  __typename?: 'Mutation';
  submitProductPropertiesStep?: {
    __typename?: 'Product';
...
export const SubmitProductPropertiesStepDocument = gql`
  mutation SubmitProductPropertiesStep($input: SubmitProductPropertiesStepInput!) {
    submitProductPropertiesStep(input: $input) {
      ...ProductInfo
    }
  }
  ${ProductInfoFragmentDoc}
`;
export type SubmitProductPropertiesStepMutationFn = Apollo.MutationFunction<
  SubmitProductPropertiesStepMutation,
  SubmitProductPropertiesStepMutationVariables
>;

/**
 * __useSubmitProductPropertiesStepMutation__
 *
 * To run a mutation, you first call `useSubmitProductPropertiesStepMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubmitProductPropertiesStepMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [submitProductPropertiesStepMutation, { data, loading, error }] = useSubmitProductPropertiesStepMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSubmitProductPropertiesStepMutation(
  ...
  return Apollo.useMutation<
    SubmitProductPropertiesStepMutation,
    SubmitProductPropertiesStepMutationVariables
  >(SubmitProductPropertiesStepDocument, options);
}
export type SubmitProductPropertiesStepMutationHookResult = ReturnType<
  typeof useSubmitProductPropertiesStepMutation
>;
export type SubmitProductPropertiesStepMutationResult =
  Apollo.MutationResult<SubmitProductPropertiesStepMutation>;
export type SubmitProductPropertiesStepMutationOptions = Apollo.BaseMutationOptions<
  SubmitProductPropertiesStepMutation,
  SubmitProductPropertiesStepMutationVariables
>;
