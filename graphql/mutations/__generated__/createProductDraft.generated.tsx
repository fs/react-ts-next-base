...
export type CreateProductDraftMutationVariables = Types.Exact<{
  input: Types.CreateProductDraftInput;
}>;
...
export const CreateProductDraftDocument = gql`
  mutation CreateProductDraft($input: CreateProductDraftInput!) {
...
export type CreateProductDraftMutationFn = Apollo.MutationFunction<
  CreateProductDraftMutation,
  CreateProductDraftMutationVariables
>;
...
export function useCreateProductDraftMutation(
  ...
  return Apollo.useMutation<CreateProductDraftMutation, CreateProductDraftMutationVariables>(
...
export type CreateProductDraftMutationResult = Apollo.MutationResult<CreateProductDraftMutation>;
