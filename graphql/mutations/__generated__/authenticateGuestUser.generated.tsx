...
export type AuthenticateGuestUserMutationVariables = Types.Exact<{ [key: string]: never }>;

export type AuthenticateGuestUserMutation = {
  __typename?: 'Mutation';
...
export const AuthenticateGuestUserDocument = gql`
  mutation authenticateGuestUser {
    authenticateGuestUser {
      me {
        ...CurrentUserInfo
      }
...
`;
export type AuthenticateGuestUserMutationFn = Apollo.MutationFunction<
  AuthenticateGuestUserMutation,
  AuthenticateGuestUserMutationVariables
>;

/**
 * __useAuthenticateGuestUserMutation__
 *
 * To run a mutation, you first call `useAuthenticateGuestUserMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAuthenticateGuestUserMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [authenticateGuestUserMutation, { data, loading, error }] = useAuthenticateGuestUserMutation({
 *   variables: {
 *   },
 * });
 */
export function useAuthenticateGuestUserMutation(
  ...
  return Apollo.useMutation<AuthenticateGuestUserMutation, AuthenticateGuestUserMutationVariables>(
    AuthenticateGuestUserDocument,
    options,
  );
}
export type AuthenticateGuestUserMutationHookResult = ReturnType<
  typeof useAuthenticateGuestUserMutation
>;
export type AuthenticateGuestUserMutationResult =
  Apollo.MutationResult<AuthenticateGuestUserMutation>;
export type AuthenticateGuestUserMutationOptions = Apollo.BaseMutationOptions<
  AuthenticateGuestUserMutation,
  AuthenticateGuestUserMutationVariables
>;
