...
export type CreateProductFromTemplateMutationVariables = Types.Exact<{
  input: Types.CreateProductFromTemplateInput;
}>;

export type CreateProductFromTemplateMutation = {
  __typename?: 'Mutation';
...
export const CreateProductFromTemplateDocument = gql`
  mutation CreateProductFromTemplate($input: CreateProductFromTemplateInput!) {
    createProductFromTemplate(input: $input) {
      ...ProductInfo
    }
  }
  ${ProductInfoFragmentDoc}
`;
export type CreateProductFromTemplateMutationFn = Apollo.MutationFunction<
  CreateProductFromTemplateMutation,
  CreateProductFromTemplateMutationVariables
>;

/**
 * __useCreateProductFromTemplateMutation__
 *
 * To run a mutation, you first call `useCreateProductFromTemplateMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateProductFromTemplateMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createProductFromTemplateMutation, { data, loading, error }] = useCreateProductFromTemplateMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateProductFromTemplateMutation(
  ...
  return Apollo.useMutation<
    CreateProductFromTemplateMutation,
    CreateProductFromTemplateMutationVariables
  >(CreateProductFromTemplateDocument, options);
}
export type CreateProductFromTemplateMutationHookResult = ReturnType<
  typeof useCreateProductFromTemplateMutation
>;
export type CreateProductFromTemplateMutationResult =
  Apollo.MutationResult<CreateProductFromTemplateMutation>;
export type CreateProductFromTemplateMutationOptions = Apollo.BaseMutationOptions<
  CreateProductFromTemplateMutation,
  CreateProductFromTemplateMutationVariables
>;
