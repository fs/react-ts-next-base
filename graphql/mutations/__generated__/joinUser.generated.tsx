...
export type JoinUserMutationVariables = Types.Exact<{
  input: Types.JoinUserInput;
}>;

export type JoinUserMutation = {
  __typename?: 'Mutation';
  joinUser?: {
...
`;
export type JoinUserMutationFn = Apollo.MutationFunction<
  JoinUserMutation,
  JoinUserMutationVariables
>;
 ...
 * });
 */
export function useJoinUserMutation(
  baseOptions?: Apollo.MutationHookOptions<JoinUserMutation, JoinUserMutationVariables>,
) {
...
export type JoinUserMutationOptions = Apollo.BaseMutationOptions<
  JoinUserMutation,
  JoinUserMutationVariables
>;
