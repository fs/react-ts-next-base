...
export type UpdateUserPhoneMutationVariables = Types.Exact<{
  input: Types.UpdateUserPhoneInput;
}>;
...
export function useUpdateUserPhoneMutation(
  ...
  return Apollo.useMutation<UpdateUserPhoneMutation, UpdateUserPhoneMutationVariables>(
