...
export type AddProductToFavoritesMutationVariables = Types.Exact<{
  input: Types.AddProductToFavoritesInput;
}>;

export type AddProductToFavoritesMutation = {
  __typename?: 'Mutation';
...
export const AddProductToFavoritesDocument = gql`
  mutation AddProductToFavorites($input: AddProductToFavoritesInput!) {
    addProductToFavorites(input: $input) {
      ...ProductInfo
    }
  }
...
export type AddProductToFavoritesMutationHookResult = ReturnType<
  typeof useAddProductToFavoritesMutation
>;
export type AddProductToFavoritesMutationResult =
  Apollo.MutationResult<AddProductToFavoritesMutation>;
