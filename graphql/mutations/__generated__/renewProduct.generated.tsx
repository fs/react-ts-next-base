...
export type RenewProductMutationVariables = Types.Exact<{
  input: Types.RenewProductInput;
}>;

export type RenewProductMutation = {
  __typename?: 'Mutation';
  renewProduct?: {
    __typename?: 'Product';
...
export const RenewProductDocument = gql`
  mutation renewProduct($input: RenewProductInput!) {
    renewProduct(input: $input) {
      ...ProductInfo
    }
  }
  ${ProductInfoFragmentDoc}
`;
export type RenewProductMutationFn = Apollo.MutationFunction<
  RenewProductMutation,
  RenewProductMutationVariables
>;

/**
 * __useRenewProductMutation__
 *
 * To run a mutation, you first call `useRenewProductMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRenewProductMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [renewProductMutation, { data, loading, error }] = useRenewProductMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useRenewProductMutation(
  baseOptions?: Apollo.MutationHookOptions<RenewProductMutation, RenewProductMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<RenewProductMutation, RenewProductMutationVariables>(
    RenewProductDocument,
    options,
  );
}
export type RenewProductMutationHookResult = ReturnType<typeof useRenewProductMutation>;
export type RenewProductMutationResult = Apollo.MutationResult<RenewProductMutation>;
export type RenewProductMutationOptions = Apollo.BaseMutationOptions<
  RenewProductMutation,
  RenewProductMutationVariables
>;
