...
export type SubmitProductBasicStepMutationVariables = Types.Exact<{
  input: Types.SubmitProductBasicStepInput;
}>;

export type SubmitProductBasicStepMutation = {
  __typename?: 'Mutation';
  submitProductBasicStep?: {
    __typename?: 'Product';
...
export const SubmitProductBasicStepDocument = gql`
  mutation SubmitProductBasicStep($input: SubmitProductBasicStepInput!) {
    submitProductBasicStep(input: $input) {
      ...ProductInfo
    }
  }
  ${ProductInfoFragmentDoc}
`;
export type SubmitProductBasicStepMutationFn = Apollo.MutationFunction<
  SubmitProductBasicStepMutation,
  SubmitProductBasicStepMutationVariables
>;

/**
 * __useSubmitProductBasicStepMutation__
 *
 * To run a mutation, you first call `useSubmitProductBasicStepMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubmitProductBasicStepMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [submitProductBasicStepMutation, { data, loading, error }] = useSubmitProductBasicStepMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSubmitProductBasicStepMutation(
  ...
  return Apollo.useMutation<
    SubmitProductBasicStepMutation,
    SubmitProductBasicStepMutationVariables
  >(SubmitProductBasicStepDocument, options);
}
export type SubmitProductBasicStepMutationHookResult = ReturnType<
  typeof useSubmitProductBasicStepMutation
>;
export type SubmitProductBasicStepMutationResult =
  Apollo.MutationResult<SubmitProductBasicStepMutation>;
export type SubmitProductBasicStepMutationOptions = Apollo.BaseMutationOptions<
  SubmitProductBasicStepMutation,
  SubmitProductBasicStepMutationVariables
>;
