...
export type ProductsReviewsQueryVariables = Types.Exact<{
  searchQuery?: Types.InputMaybe<Types.Scalars['String']>;
  after?: Types.InputMaybe<Types.Scalars['String']>;
  first?: Types.InputMaybe<Types.Scalars['Int']>;
  orderBy?: Types.InputMaybe<Types.ProductReviewOrderEnum>;
}>;

export type ProductsReviewsQuery = {
  __typename?: 'Query';
  productsReviews: {
...
export const ProductsReviewsDocument = gql`
  query ProductsReviews(
    $searchQuery: String
    $after: String
    $first: Int
    $orderBy: ProductReviewOrderEnum
  ) {
    productsReviews(searchQuery: $searchQuery, after: $after, first: $first, orderBy: $orderBy) {
      edges {
        node {
          ...ProductReviewsInfo
        }
...
/**
 * __useProductsReviewsQuery__
 *
 * To run a query within a React component, call `useProductsReviewsQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductsReviewsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProductsReviewsQuery({
 *   variables: {
 ...
 * });
 */
export function useProductsReviewsQuery(
  baseOptions?: Apollo.QueryHookOptions<ProductsReviewsQuery, ProductsReviewsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ProductsReviewsQuery, ProductsReviewsQueryVariables>(
    ProductsReviewsDocument,
    options,
  );
}
export function useProductsReviewsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProductsReviewsQuery, ProductsReviewsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ProductsReviewsQuery, ProductsReviewsQueryVariables>(
    ProductsReviewsDocument,
    options,
  );
}
export type ProductsReviewsQueryHookResult = ReturnType<typeof useProductsReviewsQuery>;
export type ProductsReviewsLazyQueryHookResult = ReturnType<typeof useProductsReviewsLazyQuery>;
export type ProductsReviewsQueryResult = Apollo.QueryResult<
  ProductsReviewsQuery,
  ProductsReviewsQueryVariables
>;
