...
export type MyProductsQueryVariables = Types.Exact<{
...
export function useMyProductsQuery(
  baseOptions?: Apollo.QueryHookOptions<MyProductsQuery, MyProductsQueryVariables>,
) {
...
export function useMyProductsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MyProductsQuery, MyProductsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
