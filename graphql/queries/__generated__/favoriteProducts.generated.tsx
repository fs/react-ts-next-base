...
export const FavoriteProductsDocument = gql`
  query favoriteProducts($searchQuery: String, $first: Int, $after: String) {
    favoriteProducts(searchQuery: $searchQuery, first: $first, after: $after) {
      edges {
        node {
          ...ProductInfo
        }
...
export function useFavoriteProductsQuery(
  baseOptions?: Apollo.QueryHookOptions<FavoriteProductsQuery, FavoriteProductsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FavoriteProductsQuery, FavoriteProductsQueryVariables>(
    FavoriteProductsDocument,
    options,
  );
}
export function useFavoriteProductsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FavoriteProductsQuery, FavoriteProductsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<FavoriteProductsQuery, FavoriteProductsQueryVariables>(
    FavoriteProductsDocument,
    options,
  );
}
...
export type FavoriteProductsQueryResult = Apollo.QueryResult<
