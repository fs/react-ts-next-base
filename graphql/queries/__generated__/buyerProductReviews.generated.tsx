...
export type BuyerProductReviewsQueryVariables = Types.Exact<{
...
export type BuyerProductReviewsQuery = {
  __typename?: 'Query';
  buyerProductReviews: {
...
export const BuyerProductReviewsDocument = gql`
...
/**
 * __useBuyerProductReviewsQuery__
 *
 * To run a query within a React component, call `useBuyerProductReviewsQuery` and pass it any options that fit your needs.
 * When your component renders, `useBuyerProductReviewsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBuyerProductReviewsQuery({
 *   variables: {
 ...
 * });
 */
export function useBuyerProductReviewsQuery(
  baseOptions: Apollo.QueryHookOptions<BuyerProductReviewsQuery, BuyerProductReviewsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<BuyerProductReviewsQuery, BuyerProductReviewsQueryVariables>(
    BuyerProductReviewsDocument,
    options,
  );
}
export function useBuyerProductReviewsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    BuyerProductReviewsQuery,
    BuyerProductReviewsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<BuyerProductReviewsQuery, BuyerProductReviewsQueryVariables>(
    BuyerProductReviewsDocument,
    options,
  );
}
export type BuyerProductReviewsQueryHookResult = ReturnType<typeof useBuyerProductReviewsQuery>;
export type BuyerProductReviewsLazyQueryHookResult = ReturnType<
  typeof useBuyerProductReviewsLazyQuery
>;
export type BuyerProductReviewsQueryResult = Apollo.QueryResult<
  BuyerProductReviewsQuery,
  BuyerProductReviewsQueryVariables
>;
